...
import { current } from "@reduxjs/toolkit";
  ...
  const FormInvoice = ({ navigation, route }) => {
    ...
    const validationSchema = Yup.object().shape({
      ...
      // invoicePict: Yup.string().required("Invoice Picture is required"),
        ...
        onSubmit: async (values) => {
          ...
          // }
            try {
              ...
              formData.append("distributorId", values.distributorId);
              formData.append("jumlahTagihan", values.jumlahTagihan);
              formData.append("invoicePict", {
                uri: image,
                type: "image/jpeg",
                name: "invoice.jpeg",
              });
              formData.append("tanggalTagihan","20-20-20");
              formData.append("tanggalJatuhTempo","20-20-20");
          ...
          >
            <Dropdown
              ...
              onChange={(item) => {
                ...
                setFieldValue("distributorId", item.id);
              }}
